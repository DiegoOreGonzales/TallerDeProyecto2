...
| **IM-04** | 12/03/2026 | **Incompatibilidad de Windows Home sin WSL2:** Dos integrantes del equipo disponían de laptops con Windows Home sin la característica de virtualización WSL2 activa, lo cual impedía levantar la red de contenedores de Docker. | Bloqueó el avance inicial de configuración (Sprint 0). | Alta | El líder técnico guió a los integrantes en la activación de virtualización en la BIOS e instaló de forma asistida el núcleo WSL2 e imágenes de Ubuntu para habilitar el uso de Docker Desktop. | **Resuelto** |
| **IM-05** | 20/05/2026 | **Cuello de botella en revisiones de código:** La carga académica del Scrum Master impidió que las ramas de Git fueran aprobadas a tiempo, acumulando Pull Requests listos para merge en GitHub. | Retrasó la integración del backend con el frontend por 2 días en el Sprint 4. | Media | Se modificó la política de ramificación en GitHub, permitiendo que cualquier integrante verifique y apruebe Pull Requests que cumplan con la checklist de integración automática de SonarQube y Pytest. | **Resuelto** |

---

## 💡 Lecciones de Gestión

El Scrum Master lideró la remoción de impedimentos de forma activa mediante reuniones diarias de sincronización (Dailies), coordinando con el Product Owner para priorizar los bloqueos en el Backlog del sprint de calidad. La lección principal fue descentralizar las tareas de control administrativo para evitar cuellos de botella individuales.
