...
| :--- | :--- | :--- |
| **Modelado del Problema** | [Restricciones_Sistema.md](../planificacion/Restricciones_Sistema.md) | **Criterio 2:** Define formalmente las restricciones duras (contigüidad, colisión) y blandas (turnos). |
| **Especificación SDD** | [Especificacion_SDD.md](../especificaciones/Especificacion_SDD.md) | **Criterio 3:** Implementa Spec-Driven Development con BDD (Gherkin) y sustento de Google Antigravity. |
