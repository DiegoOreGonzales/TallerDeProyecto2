...
Mediante el análisis de stakeholders documentado en [`analisis_requerimientos_mape.md`](../gestion/analisis_requerimientos_mape.md), se identificaron 9 nuevos requerimientos funcionales, priorizados con metodología MoSCoW:
...
│   │   └── ...
│   ├── evaluaciones/
│   │   ├── inspeccion04.md                  ← Rúbrica del docente
